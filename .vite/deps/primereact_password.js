...
var Password = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var createIcon = function createIcon2() {
    var icon2;
    if (unmaskedState) {
      icon2 = props.hideIcon || React3.createElement(EyeSlashIcon, null);
    } else {
      icon2 = props.showIcon || React3.createElement(EyeIcon, null);
    }
    var eyeIcon = IconUtils.getJSXIcon(icon2, void 0, {
      props
    });
    if (props.toggleMask) {
  ...
  var createPanel = function createPanel2() {
    ...
    var content = props.content ? ObjectUtils.getJSXElement(props.content, props) : React3.createElement(React3.Fragment, null, React3.createElement("div", {
  ...
  return React3.createElement("div", {
    ...
    className,
    style: props.style
  }, React3.createElement(InputText, _extends3({
    ref: inputRef,
    id: props.inputId
  }, inputProps, {
    type,

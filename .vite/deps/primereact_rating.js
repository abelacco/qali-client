...
import "./chunk-3SB2U25O.js";
import "./chunk-I4S4CD5Z.js";
...
var Rating = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var createIcons = function createIcons2() {
    return Array.from({
      ...
      var icon = active ? {
        type: props.onIcon || React4.createElement(StarFillIcon, {
          className: iconClassName
        })
      } : {
        type: props.offIcon || React4.createElement(StarIcon, {
          className: iconClassName
        })
      };
  ...
  var createCancelIcon = function createCancelIcon2() {
    if (props.cancel) {
      ...
      var icon = props.cancelIcon || React4.createElement(BanIcon, {
        className: iconClassName
      });
  ...
  return React4.createElement(React4.Fragment, null, React4.createElement("div", _extends4({
    ref: elementRef,
    id: props.id,
    className,
    style: props.style
  }, otherProps), cancelIcon, icons), hasTooltip && React4.createElement(Tooltip, _extends4({
    target: elementRef,

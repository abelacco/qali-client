                ...
                >
                    {
                        ...
                        <div className="w-10/12 m-3">
                            ...
                            <div className="flex justify-between">
                                <div className=" flex flex-col w-1/2">
                                    <label htmlFor="location" className="w-max">Ciudad</label>
                                    <Dropdown
                                        id="location"
                                        onBlur={formik.handleBlur} 
                                        ...
                                        className={`mb-0 mr-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('location') })}`}
                                        />
                                    {
                                        isFormFieldInvalid("location") ?
                                        <small id="userlocation-help" className="flex items-center ml-2.5 text-red-500 ">
                            ...
                            <div className= "flex flex-col">
                                    ...
                                    <div className="flex mb-3.5">
                                            ...
                                            />
                                        {
                                            ...
                                            <small id="useremail-help" className="ml-2.5 text-zinc-400">

...
const FormPatientModal = ({closeModal})=>{
    ...
    const specialties = ["Dermatología", "Neurología", "Pediatría"];
    const formik = useFormik({
        ...
        validate: (data)=>{
            ...
            if (!data.speciality) {
                errors.speciality = "Especialidad requerida.";
            }
            if (!data.email) {
                        ...
                        <div className="w-10/12 m-3">
                            <div className="flex justify-between">
                                <div className="flex flex-col w-1/2">
                                    <label htmlFor="name" className="mr-0.5 w-max">Nombre</label>
                                    <InputText 
                                        id="name" 
                                        aria-describedby="username-help" 
                                        onBlur={formik.handleBlur} 
                                        className={`mb-0 mr-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('name') })}`} 
                                ...
                                <div className=" flex flex-col w-1/2">
                                    <label htmlFor="lastName" className="ml-1 w-max">Apellido</label>
                                    <InputText 
                                        id="lastName"
                                        aria-describedby="userlastName-help" 
                                        onBlur={formik.handleBlur} 
                                        className={`mb-0 ml-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('lastName') })}`}
                                        value={formik.values.lastName} 
                                        onChange={formik.handleChange}
                                        />
                                    {
                                        isFormFieldInvalid("lastName") ?
                                        <small id="userlastName-help" className="flex items-center ml-2.5 text-red-500 ">
                            ...
                            <div className="flex justify-between">
                                <div className= "flex flex-col w-1/2">
                                    ...
                                    <div className="flex flex-col">
                                        <InputText 
                                            ...
                                            onBlur={formik.handleBlur} 
                                            className={` p-inputtext-sm mb-0 mr-0.5 ${classNames({ 'p-invalid': isFormFieldInvalid('email') })}`} 
                                            value={formik.values.email} 
                                            onChange={formik.handleChange}
                                            />
                                        {
                                            isFormFieldInvalid("email") ?
                                            <small id="useremail-help" className="flex items-center ml-2.5 text-red-500 ">
                                                {formik.errors.email}
                                            </small> :
                                            <></>
                                        }
                                ...
                                <div className=" flex flex-col w-1/2">
                                    <label htmlFor="phone" className="ml-1 w-max">Teléfono</label>
                                    <InputText 
                                        id="phone" 
                                        aria-describedby="userphone-help" 
                                        onBlur={formik.handleBlur} 
                                        className={`mb-0 ml-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('phone') })}`} 
                                        value={formik.values.phone} 
                                        onChange={formik.handleChange}
                                        />
                                    {
                                        isFormFieldInvalid("phone") ?
                                        <small id="userphone-help" className="flex items-center ml-2.5 text-red-500 ">
                                            {formik.errors.phone}
                                        </small> :
                                        <div className="h-4"></div>
                                    }
                            ...
                            <div className="flex justify-between">
                                <div className=" flex flex-col w-1/2">
                                    ...
                                    <Dropdown
                                        ...
                                        className={`mb-0 mr-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('speciality') })}`}
                                        />
                                    {
                                        isFormFieldInvalid("speciality") ?
                                        <small id="userspeciality-help" className="flex items-center ml-2.5 text-red-500 ">
                                ...
                                <div className=" flex flex-col w-1/2">
                                    <label htmlFor="city" className="ml-1 w-max">Ciudad</label>
                                    <Dropdown
                                        id="city"
                                        onBlur={formik.handleBlur} 
                                        ...
                                        className={`mb-0 ml-0.5 p-inputtext-sm ${classNames({ 'p-invalid': isFormFieldInvalid('city') })}`}
                                        />
                                    {
                                        isFormFieldInvalid("city") ?
                                        <small id="usercity-help" className="flex items-center ml-2.5 text-red-500 ">
                                            {formik.errors.city}
                                        </small> :
                                        <div className="h-4"></div>
                                    }
                                ...
                                <div className=" flex flex-col">
                                    ...
                                    <div className="flex">
                                        <Password 
                                            ...
                                            name="password"
                                            onBlur={formik.handleBlur} 
                                            className={`p-inputtext-sm mr-0.5 ${styles.passwordCenterIcon} ${classNames({ 'p-invalid': isFormFieldInvalid('password') })}`} 
                                            ...
                                            />
                                        {
                                            ...
                                            <small id="userpassword-help" className=" flex items-center ml-2.5 text-red-500 ">
                                                {formik.errors.password}
                                            </small> :
                                            <small id="useremail-help" className="flex items-center ml-2.5 text-zinc-400">
